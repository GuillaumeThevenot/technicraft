...
public class LauncherPanel extends JPanel implements SwingerEventListener {
	...
	public LauncherPanel() {
		...
		username.setFont(new Font("Impact", Font.PLAIN, 30));
		username.setBounds(515, 220, 362, 39);
		this.add(username);
		
		password.setForeground(Color.BLACK);
		//password.setFont(usernameField.getFont());
		password.setFont(new Font("Impact", Font.PLAIN, 30));
		password.setBounds(515, 341, 362, 39);
		this.add(password);
		
		technicraft.setForeground(Color.BLACK);
		//technicraft.setFont(usernameField.getFont());
		technicraft.setFont(new Font("Impact", Font.PLAIN, 60));
		technicraft.setBounds(25, 50, 562, 69);
